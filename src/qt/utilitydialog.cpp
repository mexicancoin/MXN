    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("MXN Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About MXN Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  mxn-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the MXN in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 MXN, 0.1 MXN, 1 MXN and 10 MXN -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://mexicancoin.atlassian.net/wiki/display/DOC/PrivateSend\">https://mexicancoin.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("MXN Core is shutting down...") + "<br /><br />" +
