    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("MXN Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a MXN address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and mxn: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About MXN Core"), this);
    aboutAction->setStatusTip(tr("Show information about MXN Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for MXN Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your MXN addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified MXN addresses"));
    ...
    openAction->setStatusTip(tr("Open a mxn: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the MXN Core help message to get a list with possible MXN Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("MXN Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to MXN network", "", count));
}
...
{
    QString strTitle = tr("MXN Core"); // default title
