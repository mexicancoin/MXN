    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("MXN-light"), QVariant("light"));
    ui->theme->addItem(QString("MXN-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("MXN-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("MXN-traditional"), QVariant("trad"));
