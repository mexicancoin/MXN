 ...
 *
 *   // network
 *   CMXNNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.mxn.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CMXNNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: MXNNetwork
// //   -- signature requirements : Key1(User)
// class CMXNNetworkVariable : public CGovernanceObject
// {
// private:
