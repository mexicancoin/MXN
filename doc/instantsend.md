...
This mechanism has been integrated into Bitcore-Node-MXN which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/mexicancoin/insight-api-mxn#web-socket-api](https://github.com/mexicancoin/insight-api-mxn#web-socket-api) 
* API: [https://github.com/mexicancoin/insight-api-mxn#instantsend-transactions](https://github.com/mexicancoin/insight-api-mxn#instantsend-transactions) 
...
By default, the MXN Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the MXN Core daemon:
