...
MXN Core is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as MXN Core, where everyone uses
...
pay attention to for reviewers of MXN Core code.
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: MXN Core uses tinyformat, which is type safe. Leave them out to avoid confusion
